...
export const mockNews: NewsItem[] = [
  {
    ...
    heroImage:
      "https://www.digitec.ch/Files/7/7/4/6/3/0/6/3/Screenshot_20260216-091435.Gmail_.png.webp",
    ...
    sections: [
      {
        ...
        body: "รายงานล่าสุดระบุว่า Apple ชะลอแผนพัฒนา Vision รุ่นถัดไป เพื่อโฟกัสไปที่แว่นอัจฉริยะโดยเฉพาะ รุ่นแรกอาจไม่มีจอ AR บนเลนส์ แต่จะมีกล้อง ลำโพง และทำงานผ่าน Siri รุ่นใหม่ แว่นจะต้องเชื่อมต่อกับ iPhone และอาจเปิดตัวช่วงปลายปี 2026 หรือ 2027 ราคาเบื้องต้นคาดว่าอยู่ราว 400–600 ดอลลาร์",
        sortOrder: 1,
      ...
      },
      {
        ...
        body: "ถ้าคุณรอ AR แบบเห็นภาพซ้อนบนโลกจริง รุ่นแรกอาจยังไม่ถึงจุดนั้น แต่ถ้าคุณสนใจผู้ช่วย AI แบบสวมใส่ได้ตลอดวัน นี่อาจเป็นก้าวแรกของ Apple ในตลาดนี้ และถ้าคุณเพิ่งลงทุนกับอุปกรณ์ AR อื่น คำถามคือคุณอยากรอเวอร์ชันที่สมบูรณ์กว่านี้หรือไม่",
        sortOrder: 2,
  ...
  },
  {
    ...
    heroImage:
      "https://image.cnbcfm.com/api/v1/image/106941688-1631644205737-AppleEventSEP14KeynoteTim_Cook02.jpg?v=1674567719",
  ...
  },
  {
    ...
    summary:
      "แหล่งข่าวระบุ MacBook Air M4 จะเปิดตัวในงาน WWDC 2026 มาพร้อม MagSafe 4 และ Thunderbolt 5",
    excerpt:
      "MacBook Air M4 อาจเปิดตัวกลางปีนี้ ใช้ชิป M4 ประสิทธิภาพดีขึ้น ~30% พอร์ต MagSafe 4 ชาร์จเร็วขึ้น",
    type: "NEWS",
    status: "PUBLISHED",
    ...
    metaDescription:
      "สรุปข่าว MacBook Air M4: เปิดตัวคาด WWDC 2026 มี MagSafe 4, Thunderbolt 5 และ RAM เริ่ม 16 GB",
    heroImage:
      "https://image.cnbcfm.com/api/v1/image/106941688-1631644205737-AppleEventSEP14KeynoteTim_Cook02.jpg?v=1674567719",
  ...
  },
  {
    ...
    summary:
      "รายงานใหม่ระบุ Ultra 3 ใช้ Micro LED และโหมดประหยัดพลังงานได้สูงสุด 72 ชั่วโมง",
    excerpt:
      "Apple Watch Ultra 3 จะใช้จอ Micro LED สว่างขึ้น ประหยัดไฟขึ้น ทำให้โหมด Low Power ใช้ได้นาน 72 ชม.",
    type: "NEWS",
    status: "PUBLISHED",
    ...
    metaDescription:
      "ข่าวลือ Ultra 3 ใช้ Micro LED เพิ่มความสว่างและประหยัดไฟ โหมด Low Power ได้นาน 72 ชม.",
    heroImage:
      "https://www.shutterstock.com/image-photo/alanya-turkey-april-18-2020-600nw-1774689434.jpg",
  ...
  },
  {
    ...
    summary:
      "อัปเดต iOS 19.3 เพิ่มโหมด Academic ใน Writing Tools แก้บั๊ก Face ID อากาศหนาว และเริ่มรองรับ Siri ภาษาไทย",
    excerpt:
      "iOS 19.3 ปล่อยแล้ว เพิ่ม Writing Tools โหมด Academic, Fix Face ID อุณหภูมิต่ำ และ Siri ภาษาไทยเบื้องต้น",
    type: "NEWS",
    status: "PUBLISHED",
    ...
    metaDescription:
      "สรุปฟีเจอร์ใหม่ใน iOS 19.3: Writing Tools Academic, Fix Face ID หนาว, Siri ภาษาไทยเบื้องต้น",
    heroImage:
      "https://image.cnbcfm.com/api/v1/image/106941688-1631644205737-AppleEventSEP14KeynoteTim_Cook02.jpg?v=1674567719",
  ...
  },
  {
    ...
    summary:
      "AirPods Pro 3 ผ่าน FDA เป็นเครื่องช่วยฟัง OTC รุ่นแรกจากบริษัทเทค พร้อม ANC ดีขึ้น 40%",
    excerpt:
      "AirPods Pro 3 ถูกจัดเป็นอุปกรณ์ช่วยฟังอย่างเป็นทางการ ANC ดีขึ้น 40% แบต 8 ชม. (ANC on)",
    type: "NEWS",
    status: "PUBLISHED",
    ...
    metaDescription:
      "AirPods Pro 3 ผ่าน FDA เป็น OTC hearing aid ANC ดีขึ้น 40% Conversation Awareness ฉลาดขึ้น",
    heroImage:
      "https://www.reuters.com/resizer/v2/JOUXU36QQBNJRASBC67BDNC2YI.jpg?auth=1bff1a1ea91ab110a608e1789a6a778a8c3fbc1a0e6cb4bcf52ee799b852077a&width=1080&quality=80",
  ...
  },
  {
    ...
    summary:
      "Ming-Chi Kuo ระบุ iPad Pro ปี 2026 อาจใช้ชิป M4 Ultra CPU 32c GPU 80c พร้อม RAM เริ่ม 32 GB",
    excerpt:
      "iPad Pro รุ่นใหม่ลือใช้ M4 Ultra เทียบ Mac Pro เน้น AI on-device และจอ OLED 13.3 นิ้ว",
    type: "NEWS",
    status: "PUBLISHED",
    ...
    metaDescription:
      "ข่าวลือ iPad Pro ใช้ M4 Ultra, จอ OLED 13.3 นิ้ว, RAM 32 GB เริ่มต้น, รองรับ Apple Pencil 4",
    heroImage:
      "https://image.cnbcfm.com/api/v1/image/106941688-1631644205737-AppleEventSEP14KeynoteTim_Cook02.jpg?v=1674567719",
  ...
  },
  {
    ...
    summary:
      "นักวิเคราะห์คาด Apple อาจลดราคา Vision Pro รุ่นใหม่เพื่อต่อสู้คู่แข่ง AR/VR",
    excerpt:
      "มีรายงานว่า Vision Pro รุ่นถัดไปอาจราคาลดลง 20-25% จากรุ่นแรก เพื่อลดอุปสรรคการเข้าถึงตลาด",
    type: "NEWS",
    status: "PUBLISHED",
    ...
    metaDescription:
      "ข่าวลือ Vision Pro รุ่นถัดไปอาจลดราคา 20-25% เพื่อดันยอดขาย และปรับสเปกบางส่วน",
    heroImage:
      "https://image.cnbcfm.com/api/v1/image/106941688-1631644205737-AppleEventSEP14KeynoteTim_Cook02.jpg?v=1674567719",
  ...
  },
  {
    ...
    title:
      "แผน Apple Intelligence เตรียมย้ายประมวลผลขึ้นอุปกรณ์มากขึ้นใน iOS 20",
    summary:
      "เอกสารภายในเผย Apple จะเพิ่มสัดส่วน on-device processing สำหรับ Apple Intelligence ใน iOS 20 เพื่อลด latency",
    excerpt:
      "Apple ตั้งเป้า iOS 20 ให้ Apple Intelligence ทำงานบนเครื่องมากขึ้น ลดพึ่งพาเซิร์ฟเวอร์ เพิ่มความเป็นส่วนตัว",
    type: "ANALYSIS",
    status: "PUBLISHED",
    ...
    metaDescription:
      "วิเคราะห์แผน Apple Intelligence ย้ายการประมวลผลมา on-device ใน iOS 20 ลด latency เพิ่ม privacy",
    heroImage:
      "https://image.cnbcfm.com/api/v1/image/106941688-1631644205737-AppleEventSEP14KeynoteTim_Cook02.jpg?v=1674567719",
  ...
  },
  {
    ...
    summary:
      "ข่าวลือชี้ HomePod 3 จะใส่ชิป UWB รุ่นใหม่ รองรับการค้นหาตำแหน่งและ Handoff แม่นยำกว่าเดิม",
    excerpt:
      "HomePod รุ่นใหม่อาจเพิ่ม UWB สำหรับจับตำแหน่งอุปกรณ์ Apple ในห้อง และปรับลำโพงให้เสียงกว้างขึ้น",
    ...
    metaDescription:
      "ข่าวลือ HomePod 3 จะมี UWB รองรับ Handoff แม่นยำขึ้น และเสียงกว้างขึ้น",
    heroImage:
      "https://image.cnbcfm.com/api/v1/image/106941688-1631644205737-AppleEventSEP14KeynoteTim_Cook02.jpg?v=1674567719",
